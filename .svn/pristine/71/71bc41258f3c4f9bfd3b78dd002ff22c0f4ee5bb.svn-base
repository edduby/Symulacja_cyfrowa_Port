...
public: 
	...
	double czasPrzybyciaZgeneratora;
	double czasPrzybycia;
	double czasWplynieciaDoKanalu;
	double czasPrzeplyniecia(Kanal *wybrany);
	double czasRozladunku();
	double czasZajeciaNarzedzi;
	void czazOczekiwania(double czas);
	double czasPrzeplynieciaPrzezKanal;
	int wKtorymTorzeJestem(Statek *plynie);//< Wybiore kanal w ktorym jestem
	ofstream statystyki;
	static void resetStatystyk();
	//pojawienieSieStatku
	//czas
